...
RavenHttpClient.prototype.patch = function(path, query, content, headers, callback) {
  var self = this;
  self.wrapRequest({
      method: 'PATCH',
      uri: self.buildUrl(path, query),
...
RavenHttpClient.prototype.delete = function(path, query, content, headers, callback) {
  var self = this;
  self.wrapRequest({
      method: 'DELETE',
      uri: self.buildUrl(path, query),
